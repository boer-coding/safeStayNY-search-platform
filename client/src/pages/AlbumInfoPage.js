          ...
          <TableBody>
            {
              ...
              <TableRow key={s.song_id}>
                <TableCell key='#'>{s.number}</TableCell>
                <TableCell key='Title'>
                  <Link onClick={() => setSelectedSongId(s.song_id)}>
                    {s.title}
                  </Link>
                </TableCell>
                <TableCell key='Plays'>{s.plays}</TableCell>
                <TableCell key='Duration'>{formatDuration(s.duration)}</TableCell>
              </TableRow>
              )
            }
          </TableBody>
